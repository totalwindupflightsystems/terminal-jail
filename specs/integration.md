...
0. The Interruptor Bash engine is integrated into the standalone CLI (default enabled) and evaluates commands against the 29 built-in rules before execution.
